...
if __name__ == '__main__':
    ...
    found_fonts = copy_fonts(ofl_dir, args.lang, args.output_dir, max_fonts=args.num_fonts, found_fonts=0)
    found_fonts = copy_fonts(apache_dir, args.lang, args.output_dir, max_fonts=args.num_fonts, found_fonts=found_fonts)
